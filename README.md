I have update this TPOT terraform and added terraform code to create new VPC
Please generate a private and public key - named tpot.pem and copy the public key in the main.tf

Below is from the original authur of this amazing TPOTCE 
